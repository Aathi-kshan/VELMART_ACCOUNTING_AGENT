...
enum ColumnType {
  ...
  ///
  /// Excludes ATTACHMENT. The type parses, renders and round-trips — but
  /// attachment upload was deferred, so a column created with it shows
  /// "Uploading attachments is coming soon" permanently and can never hold
  /// anything. Offering a choice that cannot work is worse than not offering
  /// it; the value stays in the enum so any column already carrying it still
  /// parses and displays.
